...
test_parser: tiger.tab.o lex.yy.o parse_err.o catch.o test_parser.o temp.o mips_frame.o dec_list_impl.o  symbol_table.o ast_translate.o mips_munch.o
	$(CXX) $(LDFLAGS) $(LIBS) -o $@ $^
...
test_semantics: tiger.tab.o lex.yy.o parse_err.o catch.o temp.o mips_frame.o dec_list_impl.o semantic_check.o symbol_table.o test_semantics.o ast_translate.o mips_munch.o
	$(CXX) $(LDFLAGS) $(LIBS) -o $@ $^
...
parse_and_print: parse_and_print.o tiger.tab.o lex.yy.o parse_err.o temp.o mips_frame.o dec_list_impl.o semantic_check.o symbol_table.o ast_translate.o mips_munch.o
	$(CXX) $(LDFLAGS) $(LIBS) -o $@ $^
